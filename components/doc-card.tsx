...
import { FlossumEngine, ITerminal, colors } from "../utils/engine";
...
export default function DocCard({
  ...
  const terminal: ITerminal = {
    write: (text: string) => {
      // If text starts with CR+Clear, we replace the line.
      // Otherwise we append.
  ...
  const runPreview = async () => {
    ...
    const method = engine[previewMethod] as Function;
  ...
  const copyToClipboard = (text: string, type: string) => {
    ...
    return (
      ...
      <div className="bg-white dark:bg-[#1e1e2e]/50 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 hover:border-[#f45455]/30 transition-all duration-300 shadow-sm dark:shadow-none">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-2">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold text-foreground font-ubuntu flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
          ...
          <div className="space-y-4">
            ...
            <div className="group relative">
              ...
              <div className="bg-gray-100 dark:bg-[#0d0d15] p-3 rounded-lg border border-gray-200 dark:border-gray-800 font-mono text-sm text-gray-800 dark:text-gray-300 flex justify-between items-center group-hover:border-gray-300 dark:group-hover:border-gray-700 transition-colors">

                <code className="truncate mr-2">{cliUsage}</code>

                <button onClick={() => copyToClipboard(cliUsage, 'cli')} className="text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-white transition-colors">

                  {copied === 'cli' ? <span className="text-green-500 dark:text-green-400 text-xs">Copied</span> : (
            ...
            <div className="group relative">
              ...
              <div className="bg-gray-100 dark:bg-[#0d0d15] p-3 rounded-lg border border-gray-200 dark:border-gray-800 font-mono text-sm text-gray-800 dark:text-gray-300 flex justify-between items-center group-hover:border-gray-300 dark:group-hover:border-gray-700 transition-colors">
                ...
                <code className="truncate mr-2 text-blue-600 dark:text-blue-300">{jsUsage}</code>

                <button onClick={() => copyToClipboard(jsUsage, 'js')} className="text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-white transition-colors">

                  {copied === 'js' ? <span className="text-green-500 dark:text-green-400 text-xs">Copied</span> : (
          ...
          <div className="flex flex-col">
             ...
             <div className="flex-grow bg-[#1e1e2e] rounded-lg border border-gray-200 dark:border-gray-800 p-4 font-mono text-sm min-h-[100px] flex items-center justify-center relative overflow-hidden">
                ...
                <div 
                  ...
                  dangerouslySetInnerHTML={{ __html: output || '<span class="text-gray-500">Click "Run Preview" to start</span>' }} 
